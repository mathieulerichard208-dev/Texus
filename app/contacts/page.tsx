  ...
  return (
    <main style={{minHeight:'100vh',background:'#0d0f14',fontFamily:'sans-serif'}}>
      <div style={{background:'#10121a',padding:'16px',borderBottom:'1px solid #1a1d2e',display:'flex',alignItems:'center',justifyContent:'space-between',position:'sticky',top:0}}>
        ...
        <div style={{fontSize:'18px',fontWeight:700,color:'#fff'}}>Contacts</div>
      ...
      {showAdd && (
        <div style={{background:'#10121a',padding:'16px',borderBottom:'1px solid #1a1d2e'}}>
          <input
            ...
            style={{width:'100%',background:'#1a1d2e',border:'1px solid #222640',borderRadius:'10px',padding:'12px',color:'#fff',fontSize:'14px',boxSizing:'border-box',marginBottom:'8px'}}
          />
          <input
            value={newPhone}
            ...
            style={{width:'100%',background:'#1a1d2e',border:'1px solid #222640',borderRadius:'10px',padding:'12px',color:'#fff',fontSize:'14px',boxSizing:'border-box',marginBottom:'8px'}}
          />
          <button onClick={addContact} style={{width:'100%',background:'#5b8dff',color:'#fff',border:'none',borderRadius:'10px',padding:'12px',fontSize:'14px',fontWeight:600,cursor:'pointer'}}>
            Ajouter
          </button>
        </div>
      )}
      ...
      <div>
        {filtered.length === 0 && (
          <div style={{textAlign:'center',color:'#555',marginTop:'60px'}}>
            ...
            <p style={{fontSize:'13px'}}>Appuie sur + pour ajouter un contact !</p>
          </div>
        )}
